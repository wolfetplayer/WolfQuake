...
int reloadableWeapons[] = {
	...
	WP_SILENCER, WP_FG42, WP_COLT,
	WP_LUGER, WP_MORTAR, WP_AKIMBO,
	WP_MAUSER, WP_SNIPERRIFLE, WP_SNOOPERSCOPE, WP_M97, WP_FG42SCOPE, WP_VENOM, WP_TESLA, -1};
...
char *BG_GetWeaponFilename( weapon_t weaponNum )
{
	switch ( weaponNum ) {
		...
		case WP_Q3_RAILGUN:        return "q3_railgun.weap";
		case WP_NONE:
